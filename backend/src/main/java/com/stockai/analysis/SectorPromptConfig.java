...
public class SectorPromptConfig {
    ...
    private static final Map<SectorType, String> INSTRUCTIONS = Map.ofEntries(
            Map.entry(SectorType.ENERGIA,
            ...
            Map.entry(SectorType.MINERACAO,
            ...
            Map.entry(SectorType.INDUSTRIA,
            ...
            Map.entry(SectorType.LOGISTICA,
            ...
            Map.entry(SectorType.PAPEL_CELULOSE,
            ...
            Map.entry(SectorType.IMOBILIARIO,
                    "Selic alta é o principal risco — encarece crédito imobiliário e comprime demanda. " +
                    "FFO (Funds from Operations) e dividend yield são as métricas centrais para FIIs. " +
                    "Vacância, localização do portfólio e qualidade dos contratos determinam resiliência."),

            Map.entry(SectorType.SAUDE,
                    "Setor defensivo com demanda estrutural inelástica. " +
                    "Margens sob pressão de sinistralidade (planos) ou custos de insumos (hospitais/farmácias). " +
                    "Regulação da ANS e reajustes de planos são fatores críticos para gestaoRisco."),

            Map.entry(SectorType.OUTROS,
